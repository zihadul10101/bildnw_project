    ...
    <AuthLayout>
      <div style={signupBox} className="w-[598px] py-4 m-4 p-3">
        <div className="pb-2 text-center">
          <h3 className="text-xl text-[#253858] py-3 font-poppins font-medium leading-5">{t("register")}</h3>
        ...
        <form onSubmit={handleSignup} className="p-5 w-[598px]">
          ...
          <p className="font-poppins font-[12px] font-medium text-[#6B778C]">(Mixture of uppercase, lowercase, numbers and symbols)</p>
